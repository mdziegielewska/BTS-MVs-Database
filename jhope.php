...
<body onload="page_init()">
	...
	<div class = "content">
		<div class = "left">
			<img src="photos/jhope.jpg" alt="Hoseok" class = "align-left"/>
		</div>
		<div class = "right">
<style>
.pp {
...
<?php
	if (isset($_COOKIE["username"])) {
		...
		echo "<form action='add_comment.php?member=jhope' method='post'>
...
?>
	...
	<div class="other">
<?php
	$sql2 = "SELECT Username, Comment, Date FROM comments WHERE Member='jhope' ORDER BY comments.Date DESC";
		...
		while($row2 = $result2-> fetch_assoc()) {
			...
			while($row3 = mysqli_fetch_array($result3)) {
				...
				if ((isset($_COOKIE["username"])) && ($_COOKIE["username"] == $username)) {
					$date = urlencode($date);
					echo "<form action='delete_comment.php?member=jhope&date=$date' method='post'>
