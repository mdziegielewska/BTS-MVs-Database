...
.right {
	...
	?>
		...
		<?php
			...
			echo "&nbsp  ";
			echo $xml->member[6]->thumbs_up;
			echo "&nbsp&nbsp&nbsp&nbsp&nbsp";
			echo $xml->member[6]->smiling_devil;
			echo "&nbsp&nbsp&nbsp&nbsp&nbsp";
			echo $xml->member[6]->purple_heart;
			echo "&nbsp&nbsp&nbsp&nbsp&nbsp";
			echo $xml->member[6]->microphone;
			echo "&nbsp&nbsp&nbsp&nbsp&nbsp";
			echo $xml->member[6]->loco;
			echo "&nbsp";
		?>
		</p>
		<img src="photos/emoji/thumbs_up.png" class="thumbs_up" alt="thumbs_up" usemap="#thumbs_up">
		<map name="thumbs_up">
			<area shape="rect" coords="0,0,56.1,60" alt="thumbs_up" href="like.php?member=jungkook&reaction=thumbs_up">
		</map>
		
		<img src="photos/emoji/smiling_devil.png" class="smiling_devil" alt="smiling_devil" usemap="#smiling_devil">
		<map name="smiling_devil">
			<area shape="rect" coords="0,0,56.1,60" alt="smiling_devil" href="like.php?member=jungkook&reaction=smiling_devil">
		</map>
	
		<img src="photos/emoji/purple_heart.png" class="purple_heart" alt="purple_heart" usemap="#purple_heart">
		<map name="purple_heart">
			<area shape="rect" coords="0,0,56.1,60" alt="purple_heart" href="like.php?member=jungkook&reaction=purple_heart">
		</map>
	
		<img src="photos/emoji/microphone.png" class="microphone" alt="microphone" usemap="#microphone">
		<map name="microphone">
			<area shape="rect" coords="0,0,56.1,60" alt="microphone" href="like.php?member=jungkook&reaction=microphone">
		</map>
		
		<img src="photos/emoji/loco.png" class="loco" alt="loco" usemap="#loco">
		<map name="loco">
			<area shape="rect" coords="0,0,56.1,60" alt="loco" href="like.php?member=jungkook&reaction=loco">
		</map></h4>
		</div> 
	</div>
