...
<body onload="page_init()">
	...
	<div class = "content">
		<div class = "left">
			<img src="photos/rm.jpg" alt="Namjoon" class = "align-left"/>
		</div>
		<div class = "right">
<style>
.pp {
...
?>
		...
		<?php
			...
			echo "&nbsp  ";
			echo $xml->member[0]->thumbs_up;
			echo "&nbsp&nbsp&nbsp&nbsp&nbsp";
			echo $xml->member[0]->smiling_devil;
			echo "&nbsp&nbsp&nbsp&nbsp&nbsp";
			echo $xml->member[0]->purple_heart;
			echo "&nbsp&nbsp&nbsp&nbsp&nbsp";
			echo $xml->member[0]->microphone;
			echo "&nbsp&nbsp&nbsp&nbsp&nbsp";
			echo $xml->member[0]->loco;
			echo "&nbsp";
		?>
		</p>
		...
		<map name="thumbs_up">
			<area shape="rect" coords="0,0,56.1,60" alt="thumbs_up" href="like.php?member=rm&reaction=thumbs_up">
		</map>
		
		<img src="photos/emoji/smiling_devil.png" class="smiling_devil" alt="smiling_devil" usemap="#smiling_devil">
		<map name="smiling_devil">
			<area shape="rect" coords="0,0,56.1,60" alt="smiling_devil" href="like.php?member=rm&reaction=smiling_devil">
		</map>
	
		<img src="photos/emoji/purple_heart.png" class="purple_heart" alt="purple_heart" usemap="#purple_heart">
		<map name="purple_heart">
			<area shape="rect" coords="0,0,56.1,60" alt="purple_heart" href="like.php?member=rm&reaction=purple_heart">
		</map>
	
		<img src="photos/emoji/microphone.png" class="microphone" alt="microphone" usemap="#microphone">
		<map name="microphone">
			<area shape="rect" coords="0,0,56.1,60" alt="microphone" href="like.php?member=rm&reaction=microphone">
		</map>
		
		<img src="photos/emoji/loco.png" class="loco" alt="loco" usemap="#loco">
		<map name="loco">
			<area shape="rect" coords="0,0,56.1,60" alt="loco" href="like.php?member=rm&reaction=loco">
		</map></h4>
	</div>
	</div>
...
<?php
	if (isset($_COOKIE["username"])) {
		...
		echo "<form action='add_comment.php?member=rm' method='post'>
...
?>
	...
	<div class="other">
<?php
	$sql2 = "SELECT Username, Comment, Date FROM comments WHERE Member='rm' ORDER BY comments.Date DESC";
		...
		while($row2 = $result2-> fetch_assoc()) {
			...
			while($row3 = mysqli_fetch_array($result3)) {
				...
				if ((isset($_COOKIE["username"])) && ($_COOKIE["username"] == $username)) {
					$date = urlencode($date);
					echo "<form action='delete_comment.php?member=rm&date=$date' method='post'>
